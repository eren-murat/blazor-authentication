...
namespace DataAccess.Models
{
	public class ObjModExtended
	{
		...
		public async void CopyFields(string username, string password, ObjModel rawObj, ISqlDataAccess sqlDataAccess)
		{
			Id = rawObj.Id;
			...
			else if (rawObj.Tip == "INT")
			{
				...
				ValoareData = DateTime.MinValue;
				ValoareInt = Int32.MinValue;
				Valori = await sqlDataAccess.GetComboboxList(username, password, rawObj.Id);
			}
